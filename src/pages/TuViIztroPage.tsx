...
export default function TuViIztroPage() {
  ...
  // Load or call AI interpretation
  ...
  }, [chartHash, chart, personName, birthDate, birthHour, gender, calendarType, refreshAccess]);
          ...
          <div className="flex justify-center">
            {hasAccess ? (
              ...
              <Badge variant="outline" className="border-destructive/50 text-destructive bg-destructive/10 px-4 py-1">
                Hết lượt luận giải · <button className="underline ml-1" onClick={() => setShowPayment(true)}>Mua thêm gói</button>
              </Badge>
            ) : null}
          </div>
        )}
                  ...
                  <Card className="max-w-sm w-full mx-4 p-6 text-center border-border bg-card shadow-xl">
                    ...
                    {hasAccess && remaining > 0 ? (
                      <>
                        ...
                        <p className="text-xs text-primary mb-4">Bạn còn {remaining}/{total} lần luận giải</p>
                        <Button
                          variant="gold"
                          size="lg"
                          className="w-full"
